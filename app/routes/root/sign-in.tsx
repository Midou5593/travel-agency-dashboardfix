...
//import { l } from "node_modules/@react-router/dev/dist/routes-DHIOx0R9";
...
const SignIn = () => {
  ...
  return (
    <main className="auth">
      <section className="size-full glassmorphism flex-center px-6 py-6">
        <div className="sign-in-card">
          <header className="header">
            ...
            <h1 className="p-28-bold">Tourvistor</h1>
          </header>
          <article>
